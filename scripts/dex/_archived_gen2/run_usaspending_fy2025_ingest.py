#!/usr/bin/env python3
"""Run FY2025 full USASpending contract ingest.

Usage:  doppler run -- python scripts/run_usaspending_fy2025_ingest.py
"""
...
ZIP_FILE_PATH = "/Users/benjamincrane/Downloads/FY2025_All_Contracts_Full_20260306.zip"
...
def main() -> int:
    print("=" * 70)
    print("USASpending.gov FY2025 Full Contract Ingest")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("=== USASPENDING FY2025 FULL INGEST COMPLETE ===")
    print("=" * 70)
