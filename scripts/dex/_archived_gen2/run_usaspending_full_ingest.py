#!/usr/bin/env python3
"""Run FY2026 full USASpending contract ingest.

Usage:  doppler run -- python scripts/run_usaspending_full_ingest.py
"""
...
def main() -> int:
    print("=" * 70)
    print("USASpending.gov FY2026 Full Contract Ingest")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("=== USASPENDING FULL INGEST COMPLETE ===")
    print("=" * 70)
